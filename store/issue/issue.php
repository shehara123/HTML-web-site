...
<td><input type="text" name="code" value="<?php echo $code; ?>"  readonly >
<input type="hidden" name="id2" value="<?php echo $id; ?>"></td>
</tr>
<tr>
<td><font color="#ffffff">Stock qty</font></td>
...
<input type="submit" name="update" value="Issue">
...
<td>
<a href="issue.php?edit=<?php echo $row['id']; ?>" class="del_btn">ISSUE</a>
</td>
</tr>
...
if (isset($_POST['update'])) {
   ...
   if($qty1>$qty2){
	...
	mysqli_query($conn, "INSERT INTO issue (code,qty,description,date) VALUES ('$code2', '$qty2','$supp','$date')");
                  }
	else {echo'<script type="text/javascript">';
	 echo'alert("No suffiecent stocks")';
	 echo'</script>';}			  
